# healthfactormonitor — A2A seller agent (managed-platform trial)

The valuable Agent and the **SOLE key-holder/signer** for the healthfactormonitor seller,
...
(`tsx src/main.ts`, no Docker) on its contract port:
